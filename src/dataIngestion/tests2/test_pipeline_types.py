...
class TestPipelineTypes(unittest.TestCase):
    ...
    def test_raw_document_required_fields(self):
        ...
        raw_doc = RawDocument(
            content="Test content", source_url="https://example.com/test"
        )
    ...
    def test_processing_context_initialization(self):
        ...
        raw_doc = RawDocument(
            content="Context test", source_url="https://example.com/context-test"
        )
    ...
    def test_processing_context_mutable_collections(self):
        ...
        raw_doc = RawDocument(
            content="Mutation test", source_url="https://example.com/mutation"
        )
        context = ProcessingContext(raw_document=raw_doc)
