...
class TestLinkExtraction(unittest.TestCase):
    ...
    def _create_mock_pipeline(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
...
"""
    ...
    def test_extract_links_empty_content(self):
        ...
        links = pipeline.extract_links_from_markdown("", "https://example.com/docs/intro.html")
        self.assertEqual(len(links), 0)
        
        links = pipeline.extract_links_from_markdown("# Just a title", "https://example.com/docs/intro.html")
        self.assertEqual(len(links), 0)
...
class TestLinkExtractionPipelineStage(unittest.TestCase):
    ...
    @patch('document_pipeline_v2.OpenAI')
    @patch('document_pipeline_v2.MarkItDown')
    def test_stage_link_extraction_success(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
...
"""
    ...
    @patch('document_pipeline_v2.OpenAI')
    @patch('document_pipeline_v2.MarkItDown')
    def test_stage_link_extraction_no_markdown(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
...
class TestPipelineIntegration(unittest.TestCase):
    ...
    @patch('document_pipeline_v2.OpenAI')
    @patch('document_pipeline_v2.MarkItDown')
    def test_process_document_includes_link_extraction(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
...
class TestCLICrawlingFunctionality(unittest.TestCase):
    ...
    def test_prompt_user_for_link_selection_all(self, mock_input):
        ...
        links = [
            {'url': 'https://example.com/docs/guide.html', 'text': 'User Guide', 'title': ''},
            {'url': 'https://example.com/docs/api.md', 'text': 'API Reference', 'title': ''},
        ]
    ...
    def test_prompt_user_for_link_selection_specific(self, mock_input):
        ...
        links = [
            {'url': 'https://example.com/docs/guide.html', 'text': 'User Guide', 'title': ''},
            {'url': 'https://example.com/docs/api.md', 'text': 'API Reference', 'title': ''},
            {'url': 'https://example.com/docs/tutorial.html', 'text': 'Tutorial', 'title': ''},
        ]
