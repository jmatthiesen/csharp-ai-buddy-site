...
class TestAICategorization(unittest.TestCase):
    ...
    def test_semantic_kernel_agents_categorization(self):
        ...
        # Test categorization
        result = categorize_with_ai(
            self.test_content["semantic_kernel_agents"], self.mock_openai_client
        )
...
class TestOpenAIEvaluation(unittest.TestCase):
    ...
    def test_real_semantic_kernel_agents_categorization(self):
        ...
        self.assertIn(
            "Semantic Kernel Agents", result, "Real API should detect Semantic Kernel Agents"
        )
        self.assertIn(
            "Semantic Kernel", result, "Real API should include parent Semantic Kernel tag"
        )
    ...
    def test_two_tags(self):
        ...
        self.assertIn("Semantic Kernel", result, "Real API should detect Semantic Kernel")
        self.assertIn(
            "Microsoft.Extensions.AI", result, "Real API should detect Microsoft.Extensions.AI"
        )
