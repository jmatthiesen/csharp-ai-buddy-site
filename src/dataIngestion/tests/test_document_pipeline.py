...
class TestDocumentPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_markitdown.convert.return_value = Mock(markdown="# Test Markdown\n\nThis is test content.")
    
    @patch('document_pipeline.MongoClient')
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_convert_to_markdown(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_generate_embeddings(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_process_document_full_pipeline(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_store_document(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    def test_get_document(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
        ...
        # Verify retrieval
        self.mock_documents_collection.find_one.assert_called_once_with({"documentId": "https://example.com/test"})
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_search_documents(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_process_document_with_pre_parsed_content(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_process_document_with_empty_content(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_process_document_with_ai_categorization(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_store_document_duplicate_key_error(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    def test_process_document_with_chunking(self, mock_chunk_markdown, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
        ...
        self.assertEqual(chunk1.markdownContent, "# Chapter 1\n\nThis is the first chunk of content.")
        self.assertEqual(chunk1.metadata["chunk_index"], 0)
        self.assertEqual(chunk1.metadata["total_chunks"], 2)
        self.assertEqual(chunk1.metadata["original_document_id"], "https://example.com/long-document")
        ...
        self.assertEqual(chunk2.markdownContent, "# Chapter 2\n\nThis is the second chunk of content.")
    ...
    @patch('document_pipeline.OpenAI')
    @patch('document_pipeline.MarkItDown')
    def test_store_document_chunks(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
    ...
    @patch('document_pipeline.MarkItDown')
    @patch('document_pipeline.chunk_markdown')
    def test_process_and_store_document_with_chunking(self, mock_chunk_markdown, mock_markitdown_class, mock_openai_class, mock_mongo_client_class):
        ...
        self.assertEqual(stored_ids[0], "https://example.com/test")  # No chunk suffix for single chunk
        self.mock_documents_collection.insert_one.assert_called_once()
