...
class TestWebPageRetriever(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_response.text = "<html><head><title>Test Page</title></head><body><h1>Test Content</h1></body></html>"
    ...
    def test_fetch_and_process_document_integration(self, mock_markitdown_class, mock_openai_class, mock_mongo_client_class, mock_requests):
        ...
        mock_markitdown.convert.return_value = Mock(markdown="# Test Markdown\n\nThis is test content.")
        ...
        mock_requests.get.assert_called_once_with("https://example.com/integration-test", timeout=10)
