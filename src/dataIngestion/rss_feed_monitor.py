...
class RSSFeedMonitor:
    ...
    def _create_indexes(self):
        ...
        try:
            ...
            self.processed_items_collection.create_index(
                [("feed_url", 1), ("item_id", 1)], unique=True
            )
    ...
    try:
        if args.command == "add-subscription":
            success = monitor.add_subscription(
                feed_url=args.feed_url, name=args.name, description=args.description, tags=args.tags
            )
