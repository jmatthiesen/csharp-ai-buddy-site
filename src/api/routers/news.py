...
async def get_news(
    ...
    page_size: int = Query(
        20, ge=1, le=100, description="Number of news items per page"
    ),
...
async def get_news_rss():
    ...
    try:
        ...
        cursor = (
            documents_collection.find(query)
            .sort([("publishedDate", -1), ("indexedDate", -1)])
            .limit(50)
        )
        ...
        ET.SubElement(channel, "description").text = (
            "Latest news and articles about .NET and AI development"
        )
        ...
        for doc in news_data:
            ...
            ET.SubElement(item, "guid").text = doc.get(
